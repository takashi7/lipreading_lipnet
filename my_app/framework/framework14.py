...
class MyFrame(wx.Frame):
    ...
    def button_onLoadFile(self, evt):
        ...
        path = '/home/takashi/try/honnda/framework/video2/pppp-2018-09-07_10.16.45.mp4'
    ...
    def doLoadFile1(self, evt):
        ...
        path = '/home/takashi/try/honnda/framework/video2/pppp1-2018-09-07_10.20.26.mp4'
    ...
    def doLoadFile2(self, evt):
        ...
        path = '/home/takashi/try/honnda/framework/video2/pppp2-2018-09-07_10.26.39.mp4'
    ...
    def doLoadFile3(self, evt):
        ...
        path = '/home/takashi/try/honnda/framework/video2/pppp3-2018-09-07_10.27.58.mp4'
    ...
    def button_lipreading(self, e):
        ...
        if self.k == 2:
            self.panel_video.Destroy()
        self.k = 1        
        video = np.load('/home/takashi/try/honnda/predict/team/3/video_face.npy')
        self.frame = video
        self.bmp = create_wx_bitmap_from_cv2_image(self.frame[0])
        self.bmp = scale_bitmap(self.bmp, 400, 350)
        text = np.load('/home/takashi/try/honnda/predict/team/3/result_split.npy')
        self.subtitle = text
        self.inc = max(len(self.frame)/(len(self.subtitle)+1), 0.01)
