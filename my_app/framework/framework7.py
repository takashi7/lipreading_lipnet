...
class MyFrame(wx.Frame):
    def __init__(self, parent, title, fps=25):
        ...
        self.button1 = wx.Button(self.panel_button, wx.ID_ANY, 'Musuic', size=(100, 50))
        ...
        self.button4.Bind(wx.EVT_BUTTON, self.click_button_start, self.button4)

        self.button5 = wx.Button(self.panel_button, wx.ID_ANY, 'Play', size=(100, 50))
        self.button5.Bind(wx.EVT_BUTTON, self.click_button_start, self.button5)
        self.button6 = wx.Button(self.panel_button, wx.ID_ANY, 'Pose', size=(100, 50))
        self.button6.Bind(wx.EVT_BUTTON, self.click_button_stop, self.button6)
        self.button7 = wx.Button(self.panel_button, wx.ID_ANY, 'Stop', size=(100, 50))
        self.button7.Bind(wx.EVT_BUTTON, self.click_button_start, self.button7)
